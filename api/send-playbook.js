...
const playbooks = {
  demand: {
    ...
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="font-family:Georgia,serif;max-width:560px;margin:0 auto;padding:40px 20px;color:#1c1c1c;background:#f7f4ee;">
<p style="font-size:0.85rem;color:#c47a38;margin-bottom:28px;">Malwa Asset Firm</p>
...
<ol style="color:#5c5c5c;line-height:1.8;"><li>Over-relying on one channel (60%+ from one source = revenue cliff)</li><li>Underinvesting in marketing (benchmark: 3% of revenue)</li><li>Treating all leads the same</li><li>No lead tracking by source</li><li>The owner is the marketing department</li></ol>
...
<div style="margin-top:40px;padding:28px;background:#fff;border:1px solid #c47a38;border-radius:6px;text-align:center;"><h3 style="font-size:1.1rem;font-weight:400;margin-bottom:6px;">Want the full 6-Vector Roadmap?</h3><p style="color:#5c5c5c;font-size:0.9rem;margin-bottom:16px;">This guide covers one constraint. A Growth Blocker Analysis covers all six — I pressure-test your scores against 400+ service business benchmarks and give you a complete growth roadmap in 30 minutes.</p><a href="https://cal.com/malwa-asset-firm/growth-blocker-analysis" style="display:inline-block;padding:14px 36px;background:#c47a38;color:#fff;border-radius:6px;text-decoration:none;font-weight:700;">Book a Growth Blocker Analysis →</a></div>
<p style="margin-top:32px;padding-top:20px;border-top:1px solid #e4ded4;text-align:center;font-size:0.75rem;color:#949494;">Malwa Asset Firm</p>
</body></html>`
  },
  conversion: {
...
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Most Common Mistakes</h2>
<ol style="color:#5c5c5c;line-height:1.8;"><li>Slow response time (industry avg: 14+ hours)</li><li>No follow-up on unsold estimates (top shops recover 11-15% of revenue here)</li><li>The owner is the only closer</li><li>No contact tracking</li><li>Pricing conversations happen too early</li></ol>
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Fix: Step by Step</h2>
...
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Most Common Mistakes</h2>
<ol style="color:#5c5c5c;line-height:1.8;"><li>No digital scheduling system</li><li>The owner is the dispatcher</li><li>No parts management — supply house runs during jobs</li><li>No first-time fix tracking</li><li>Revenue per truck isn't measured</li></ol>
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Fix: Step by Step</h2>
...
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Most Common Mistakes</h2>
<ol style="color:#5c5c5c;line-height:1.8;"><li>Paper invoicing — adds 2-4 weeks to collection cycle</li><li>No payment terms enforcement — "net 30" means net 45-60</li><li>Invoicing delays — 2-4 weeks after job completion</li><li>No progress billing on large jobs</li><li>No AR aging review</li></ol>
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Fix: Step by Step</h2>
...
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Most Common Mistakes</h2>
<ol style="color:#5c5c5c;line-height:1.8;"><li>No maintenance plan — the single highest-ROI move in the trades</li><li>No follow-up after the job — 52% of non-returns are communication failures</li><li>No review system — 42% of consumers won't use a business that never replies to reviews</li><li>Treating every customer as a one-time transaction</li><li>No seasonal touchpoints</li></ol>
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Fix: Step by Step</h2>
...
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Most Common Mistakes</h2>
<ol style="color:#5c5c5c;line-height:1.8;"><li>No ticket system — issues fall through cracks</li><li>The owner handles everything — single point of failure</li><li>No response to negative reviews — permanent advertisement that you don't care</li><li>No escalation process — every issue becomes an owner issue</li><li>No root cause tracking — treating symptoms instead of fixing causes</li></ol>
<h2 style="font-size:1.1rem;font-weight:400;margin-top:28px;">The Fix: Step by Step</h2>
